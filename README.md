...
- **🛡️ Scope Police:** Handles nested scopes like a boss. Tries to access a local variable from the global scope? *BEEEP* Error.
...
---
*Built with ❤️, JavaScript, and a lot of `console.log`*
